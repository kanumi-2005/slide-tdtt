...
\NewDocumentEnvironment{threetrees}{ O{} mmmmm }
 {
   ...
   % --- BƯỚC 1: VẼ CÂY 1 ---
   % Slide i: Hiện Cây 1
   \node[phu_node_style, rectangle, draw, anchor=north~west] (treeOne) at (0, 0) {#2};
   
   % --- BƯỚC 2: VẼ CÂY 2 & MŨI TÊN 1 ---
   % Slide i+1: Hiện Cây 2 (nhờ style <+->) và Mũi tên 1 (nhờ style <.->)
   \node[phu_node_style, rectangle, draw, right=#5~of~treeOne.north~east, anchor=north~west] (treeTwo) {#3};
   ...
   \node[phu_node_style, rectangle, draw, right=#5~of~treeTwo.north~east, anchor=north~west] (treeThree) {#4};
