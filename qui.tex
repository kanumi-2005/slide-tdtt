...
\begin{frame}
    ...
    Cây AVL được đặt tên theo Adelson-Velsky và Landis, là cây nhị phân tìm kiếm thỏa mãn chiều cao hai cây con của bất kỳ nút nào cũng không khác nhau quá một
\end{frame}
...
\begin{frame}
    ...
    \item Cập nhật chiều cao của nút hiện tại
    \item Tính hệ số cân bằng của nút hiện tại
    \item Xử lí các trường hợp cân bằng nếu nút mất cân bằng
    \item Lặp lại bước 2--4 cho đến nút gốc
    \end{enumerate}
    \end{block}
\end{frame}
...
\begin{frame}
    ...
    \item Cập nhật chiều cao của nút hiện tại
    \item Tính hệ số cân bằng của nút hiện tại
    \item Xử lí các trường hợp cân bằng (LL, LR, RR, RL) nếu mất cân bằng
    \item Lặp lại bước 2-4 đi lên đến nút gốc
    \end{enumerate}
    \end{block}
\end{frame}
